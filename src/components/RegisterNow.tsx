...
const Sponsor: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-x-4 text-2xl lg:text-7xl lg:pt-16 pt-8 pb-12 min-h-[50vh] gap-y-4 px-4 lg:px-8">
      <a
      ...
      >
        ...
        <div className="flex flex-col items-center z-40">
          ...
          <p className="z-40 lg:text-xl text-sm">Click Here</p>
        </div>
      </a>
      <img
