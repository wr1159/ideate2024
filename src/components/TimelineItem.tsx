...
type TimelineItemProps = {
  ...
  const TimelineItem: React.FC<TimelineItemProps> = ({ title, date, shape, textColor, link }) => {
    ...
    return link? (
        ...
        smooth={true}
        duration={1000}
        className="cursor-pointer hover:bg-gray-700 rounded transition duration-300 w-full h-32 lg:h-56 grid grid-cols-3"
      >
